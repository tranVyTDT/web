...
*/
	...
	<div class="container-fluid sticky-top" id = "header">
		...
		<div class = "row" id = "brand">
			<form action="brand.php?check=1&amp;b=LG" class="col"  method="post" target="_blank">
				<input type="submit" name="submitLG" class="col" id = "lg" value="LG"  href="#" style="width: 100%;cursor: pointer;" >
			</form>
			<form action="brand.php?check=1&amp;b=SS" class="col"  method="post" target="_blank">
				<input type="submit" name="submitLG" class="col" id = "lg" value="SAMSUNG"  href="#" style="width: 100%;cursor: pointer;" >
			</form>
			<form action="brand.php?check=1&amp;b=AP" class="col"  method="post" target="_blank">
				<input type="submit" name="submitLG" class="col" id = "lg" value="APPLE"  href="#" style="width: 100%;cursor: pointer;" >
			</form>
			<form action="brand.php?check=1&amp;b=SN" class="col"  method="post" target="_blank">
				<input type="submit" name="submitLG" class="col" id = "lg" value="SONY"  href="#" style="width: 100%;cursor: pointer;" >
			</form>
			<form action="brand.php?check=1&amp;b=PX" class="col"  method="post" target="_blank">
				<input type="submit" name="submitLG" class="col" id = "lg" value="PIXEL"  href="#" style="width: 100%;cursor: pointer;" >
			</form>
		</div>
	...
	<div class = "container">
		...
		switch ($_REQUEST['b']) {
			case 'LG':
				$sql1 = "SELECT * FROM news WHERE Brands = 'LG'";
				break;
			case 'SS':
				$sql1 = "SELECT * FROM news WHERE Brands = 'Samsung'";
				break;
			case 'AP':
				$sql1 = "SELECT * FROM news WHERE Brands = 'Apple'";
				break;
			case 'SN':
				$sql1 = "SELECT * FROM news WHERE Brands = 'Sony'";
				break;
			case 'PX':
				$sql1 = "SELECT * FROM news WHERE Brands = 'Pixel'";
				break;
		}
