...
*/
	...
	<div class="container">
		...
		$sql1 = "SELECT * FROM news WHERE IDnews = $id ";
		...
		$row = mysqli_fetch_array($result);
			...
			echo "<h1 class= 'ms-auto' style= 'text-align: center'>";
			echo $row['Titles'];
			echo "</h1>";


			echo "<div class='row col-md-12 mx-auto' style'text-align: center;	'>";
			echo "<img src='";
			echo $row['IMGHeaders'];
			...
			echo "<div id ='videoBody' align='center'  class = 'col-md-12 px-5'>";
			echo "<iframe width='100%' height='400px'";
			echo "src='https://www.youtube.com/embed/";
			echo $row['VideoFooter'];
			echo "?autoplay=1'";
			echo "	</iframe>";
			echo "</div>";
			echo "</div>";
